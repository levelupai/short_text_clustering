...
# in this program we will classify then cluster the text of the  labelled ubuntudataset but with tf-idf count vecoriser
...
cluster_0= open('/home/levelup/Ayushi_folder/windows/ubuntu_complete_sentences_10k_output_cluster0.txt', 'w+')
cluster_1= open('/home/levelup/Ayushi_folder/windows/ubuntu_complete_sentences_10k_output_cluster1.txt', 'w+')
cluster_2= open('/home/levelup/Ayushi_folder/windows/ubuntu_complete_sentences_10k_output_cluster2.txt', 'w+')
cluster_0_ms= open('/home/levelup/Ayushi_folder/windows/ubuntu_complete_sentences_10k_output_cluster0_ms.txt', 'w+')
cluster_1_ms= open('/home/levelup/Ayushi_folder/windows/ubuntu_complete_sentences_10k_output_cluster1_ms.txt', 'w+')
cluster_2_ms= open('/home/levelup/Ayushi_folder/windows/ubuntu_complete_sentences_10k_output_cluster2_ms.txt', 'w+')
cluster_3_ms= open('/home/levelup/Ayushi_folder/windows/ubuntu_complete_sentences_10k_output_cluster3_ms.txt', 'w+')
...
print("finished vectorisation")
#
n_samples = len(Xx.toarray())
print(n_samples)
...
datasets = [
    (Xx, {'damping': .77, 'preference': -240, 'quantile': .2, 'n_clusters': 2})]
cluster_2_ms= open('/home/levelup/Ayushi_folder/ubuntuchat/ubuntu_complete_sentences_10k_output_cluster2_ms.txt', 'w+')
